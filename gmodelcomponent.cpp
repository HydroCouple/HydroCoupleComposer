...
QBrush GModelComponent::s_selectedBrush(QColor(255, 200, 220), Qt::BrushStyle::SolidPattern);
QPen GModelComponent::s_selectedPen(QBrush(QColor(255, 99, 71), Qt::BrushStyle::SolidPattern), 5.0, Qt::PenStyle::SolidLine, Qt::PenCapStyle::RoundCap, Qt::PenJoinStyle::RoundJoin);
...
QString GModelComponent::getCaption() const
{
	return m_modelComponent->getCaption();
}

void GModelComponent::setCaption(const QString & caption)
{
	m_modelComponent->setCaption(caption);
}

QString GModelComponent::getDescription() const
{
	return m_modelComponent->getDescription();
}

void GModelComponent::setDescription(const QString& description)
{
	m_modelComponent->setDescription(description);
}

const IModelComponentInfo* GModelComponent::componentInfo() const
{
	return m_modelComponent->componentInfo();
}

IModelComponent* GModelComponent::parent() const
{
	return m_modelComponent->parent();
}
...
IModelComponent* GModelComponent::clone() const
{
	return m_modelComponent->clone();
}

QList<IModelComponent*> GModelComponent::children() const
{
	return m_modelComponent->children();
}

QList<IArgument*> GModelComponent::arguments() const
{
	return m_modelComponent->arguments();
}
...
QList<IInput*> GModelComponent::inputs() const
{
	return m_modelComponent->inputs();
}

QList<IOutput*> GModelComponent::outputs() const
{
	return m_modelComponent->outputs();
}

QList<IAdaptedOutputFactory*> GModelComponent::adaptedOutputFactories() const
{
	return m_modelComponent->adaptedOutputFactories();
}

void GModelComponent::initialize()
{
	m_modelComponent->initialize();
}

QList<QString> GModelComponent::validate()
{
	return m_modelComponent->validate();
}

void GModelComponent::prepare()
{
	return m_modelComponent->prepare();
}

void GModelComponent::update(const QList<IOutput*> & requiredOutputs)
{
	m_modelComponent->update(requiredOutputs);
}

void GModelComponent::finish()
{
	m_modelComponent->finish();
}
